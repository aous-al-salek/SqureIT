...
$wrongCaptcha = '';
$fb = $_POST["user_text"] ?? '';
if ((intval($_POST['input1']) > 0) && (intval($_POST['input2']) >= 0) && is_int($_POST['input1']) && is_int($_POST['input2'])) { //stuck
...
<html lang="en-US">
    ...
    <body>
        ...
        <div class="center">
            <strong>
                <p>You can provide anonymous feedback below.</p>
                <p style="margin-bottom: 20px;">Thank you for taking the time.</p>
            </strong>
            <div class="feedback_form" id="feedback_form">
                <form action="#feedback_form" name="feedback_form" method="post">
                    ...
                    <div id="captcha-box" class="captcha-box">
                        <p style="width:240px; margin: 5px auto; color: #4CAF50; font-weight: bold;">Confirm you are not a robot!</p>
